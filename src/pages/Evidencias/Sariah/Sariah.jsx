...
import evidencia1Foto1 from "../../../assets/Sapa_Caramelo_Sariah_1.jpg";
import evidencia1Foto2 from "../../../assets/Sapa_Caramelo_Sariah_2.jpg";
import evidencia_funcion_lenguaje from "../../../assets/Funciones_Lenguaje_Sariah.pdf";
...
function Sariah() {
    ...
    const evidencias = [
...

        {
            ...
            archivos: [
                "/Tipos_Comunicacion_Sariah.docx"
            ]
        },
...

        {
            ...
            archivos: [
                "/Comunicacion_No_Verbal_Sariah.docx"
            ]
        },
        {
            numero: "05",
